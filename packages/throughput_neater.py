...
###########
# CleanThroughputDataAndVisualize is a function to do
# all cleaning functions in one swoop. It accepts
# an excel file and will load the content into
# dataframe. It will visualize all the data for visual checks
def CleanThroughputDataAndVisualize(file_excel):
    # Load the excel file
    df = LoadDFThroughput(file_excel)
